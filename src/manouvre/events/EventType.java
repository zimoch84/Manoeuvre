...
public class EventType {
    ...
    public static final String CARD_ACCEPTED = "CARD_NOT_REJECTED";
 
    public static final String COMBAT_ACCEPTED = "COMBAT_ACCEPTED";
    ...
    public static final String ATTACKER_PICK_SUPPORT = "ATTACKER_ROLL_DICES";
    public static final String PUSRUIT_SUCCEDED = "PUSRUIT_SUCCEDED";
    public static final String PUSRUIT_AFTER_COMBAT_RESOLUTION = "PUSRUIT_AFTER_COMBAT_RESOLUTION";
    ...
    public static final String CARD_GUIRELLA_PLAYED = "CARD_REJECTED";
